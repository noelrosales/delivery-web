...
class ParcelPrint extends Component {
    constructor(props) {
        super(props);
        this.state = {
            parcelData: JSON.parse(localStorage.getItem('createdParcel'))
        }
    }
    render() { 
                    ...
                    <div style={{flexDirection:'column'}}>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td>Destination: </td>
                                    <td>{parcelData.endStation.name}</td>
                                </tr>
                                <tr>
                                    <td>Date: </td>
                ...
                <div className="parcel-print">
                    <div className="qr-code">
                        <div>
                            <QRCode
                                ...
                                value={parcelData.scanCode}
                            />
                            <h2 style={{textAlign: 'center', marginTop:'24px'}}>{parcelData.scanCode}</h2>
                        </div>
                    ...
                    <div className="delivery-detail">
                        ...
                        <div className="recipient-details">
                            ...
                            <div>
                                <h3>Destination:</h3>
                                <h2>{parcelData.endStation.name}</h2>
                            </div>

                            <div className="parcel-count">
                                <h3>Parcel:</h3>
                                <h3>{`1 of ${parcelData.packageInfo.quantity}`}</h3>
                            </div>
                        </div>
                    </div>
                </div>
