...
import ReceiveService from '../../services/Receive';
...
class Receive extends Component {
    ...
    componentDidMount() {
        ReceiveService.getTrips()
            .then(res => {
                if(res.data.success === true){
                    const tripList = res.data.data.data;
                    console.log('RECEIVE TRIPS', tripList);
                    this.setState({
                        trips: tripList
                    })
                } else {
    ...
    getPackages = (tripId) => {
        ReceiveService.getPackages(tripId)
            .then(res => {
                const packages = res.data.data.list;
                const receivedCount = res.data.data.receivedCount;
